...
public class Triangle {
	...
	public int detectTriangle()
	{
		...
		if ((a*a+b*b == c*c) || (b*b + c*c == a*a)||(a*a + c*c == b*c))   //ошибка в последнем символе (д.б. b)
		{
		...
		if (a==b && b==c && a==c)
		{
			final_state = final_state|TR_EQUILATERAL; // равносторонный
		}

		if (a==b || b==c || a==c) //и при этом не равны третьей стороне
		{
